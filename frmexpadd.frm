...
Begin VB.Form frmexpadd 
   ...
   Begin VB.Image imgbtnback 
      Height          =   735
      Left            =   0
      Picture         =   "frmexpadd.frx":451DA9A
      Stretch         =   -1  'True
      ToolTipText     =   "CLICK TO GO BACK TO EXPORT PANEL "
      Top             =   0
      Width           =   855
   End
   ...
   Begin VB.Image imgbtnadd 
      Height          =   855
      Left            =   9960
      Picture         =   "frmexpadd.frx":4525504
      Stretch         =   -1  'True
      ToolTipText     =   "CLICK TO ADD RECORD"
      Top             =   11400
      Width           =   1335
   End
   ...
   Begin VB.Image imgbg1 
      Height          =   12750
      Left            =   0
      Picture         =   "frmexpadd.frx":45268CE
      Stretch         =   -1  'True
      Top             =   0
      Width           =   21405
   End
End
Attribute VB_Name = "frmexpadd"
