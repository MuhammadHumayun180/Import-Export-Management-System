...
Begin VB.Form frmimpadd 
   ...
   ControlBox      =   0   'False
   FillColor       =   &H00FFFF00&
   Icon            =   "frmimpadd.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   Picture         =   "frmimpadd.frx":18187
   ScaleHeight     =   12330
   ScaleWidth      =   21345
   ...
   Begin VB.Image imgbg1 
      Height          =   12900
      Left            =   0
      Picture         =   "frmimpadd.frx":4A15C49
      Stretch         =   -1  'True
      Top             =   0
      Width           =   21555
   End
End
Attribute VB_Name = "frmimpadd"
